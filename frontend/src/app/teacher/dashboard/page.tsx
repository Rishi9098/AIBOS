    ...
    <RouteGuard allowedRoles={['TEACHER', 'EVALUATOR', 'SUPER_ADMIN']}>
      <div className="min-h-screen bg-slate-950 text-slate-100 font-sans p-8 space-y-8">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          {/* Page Help Panel */}
          <PageHelpPanel
            pageTitle="Teacher & Evaluator Dashboard"
            purpose="This dashboard provides access to textbook-grounded question generation and AI evaluation moderation queues."
            userRole="Teacher / Evaluator / Moderation Official"
            apisExecuted={['GET /api/v1/auth/me', 'GET /api/v1/evaluation/evaluations']}
            dbTablesUpdated={['questions', 'evaluations', 'teacher_overrides']}
            nextStep="Generate a 100% traceable question or review low-confidence AI evaluation scores."
            consequenceIfSkipped="Teachers would be unable to draft traceable questions or perform human evaluation moderation."
          />
